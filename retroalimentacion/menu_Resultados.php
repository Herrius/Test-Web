                    ...
                    <div class="row ">
                        <div class="col-12 row ">
                            <div class="col-6 d-flex align-items-center">
                                ...
                                <a href="Int_Activa.php" class="flex-grow-1">
                        ...
                        <div class="col-12 row mt-2">
                            <div class="col-6 d-flex align-items-center">
                                ...
                                <a href="Int_Sensorial.php" class="flex-grow-1">
                                    <div class="progress" style="height: 3rem;">
                        ...
                        <div class="col-12 row mt-2">
                            <div class="col-6 d-flex align-items-center">
                                ...
                                <a href="Int_Visual.php" class="flex-grow-1">
                                    <div class="progress" style="height: 3rem;">
                            ...
                            <div class="col-6 d-flex align-items-center">
                                ...
                                <a href="Int_Verbal.php" class="flex-grow-1">
                                    <div class="progress" style="height: 3rem;">
