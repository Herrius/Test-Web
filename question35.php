	...
	<div class="contenedor">
		...
		<div class="contenido">
			<form >
				...
				<div>
                  <center><a href="question36.php"><input type="button" value="<?php echo $mostrar ['opcion1']?>"></a></center> 
				   <br>
                   <center><a href="question36.php"><input type="button" value="<?php echo $mostrar ['opcion2']?>"></a></center> 
				</div>
				<?php
			}
			?>
