...
<html>
    ...
    <body>
        ...
        <div class="content centered-elements">
            <div>
               <br>
                <a style="position: relative;display: block;height: 50px;width: 250px;border-radius: 50px;text-transform: uppercase;background-color: transparent;color: #fff;font-size: 18px;overflow: hidden;transition: all 500ms ease;border: 2px solid #fff;margin-bottom: 20px;z-index: 0;font-weight: 700;cursor: pointer;text-align: center;font-size: 1.2rem;padding: 0.5rem 2rem;text-decoration: none;"><?php echo $codestudiante;?></a>
                ...
                <a href="exel.php" class="btn_imprimir" type="button" value="" style="position: relative;display: block;height: 50px;width: 120px;border-radius: 50px;text-transform: uppercase;background-color: transparent;color: #fff;font-size: 18px;overflow: hidden;transition: all 500ms ease;border: 2px solid #fff;margin-bottom: 20px;z-index: 0;font-weight: 700;cursor: pointer;text-align: center;font-size: 0.7rem;padding: 0.5rem 1rem;text-decoration: none;float:left" >Descargar exel</a>
                <a href="inf/Estilos_Aprendizaje.pdf" download="EstilosdeAprendizaje.pdf" class="btn_imprimir" type="button" value="" style="position: relative;display: block;height: 50px;width: 120px;border-radius: 50px;text-transform: uppercase;background-color: transparent;color: #fff;font-size: 18px;overflow: hidden;transition: all 500ms ease;border: 2px solid #fff;margin-bottom: 20px;z-index: 0;font-weight: 700;cursor: pointer;text-align: center;font-size: 0.7rem;padding: 0.5rem 1rem;text-decoration: none;float:right" >Descargar pdf</a>
            </div>            
        </div> 
         <?php
        } 
